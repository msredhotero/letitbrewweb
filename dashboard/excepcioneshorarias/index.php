...
$insertar = "insertarExcepcionHorario";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerExcepcionHorario(),4);
...
<h3 style="color:#FFF;"><?php echo $plural; ?></h3>
